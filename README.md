...
- Native Bluetooth chat: opt-in public BitChat room, nearby friend badges, and nearby Linky contact discovery while the app is open. Private chats continue over Nostr. See [device testing and current limits](./docs/bluetooth-testing.md).
