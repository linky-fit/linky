...
export const en = {
  ...
  cashuReturnUnclaimed: "Return unclaimed",
  cashuReturningUnclaimed: "Returning…",
  cashuReturnUnclaimedNothing: "No unclaimed token to return.",
  cashuReturnUnclaimedDone: "Returned to wallet: {count} tokens ({amount}).",
  cashuReturnUnclaimedClaimed: "Already claimed: {count}.",
  cashuReturnUnclaimedFailed: "Could not return: {count}.",
  cashuTokenAutoReturnAt:
    "This unclaimed token returns to the wallet by itself {when}.",
  unclaimedTokenAutoReturn: "Return unclaimed tokens",
  unclaimedTokenAutoReturnHint:
    "An issued token nobody claims within the chosen time returns to your wallet by itself. The copy the recipient holds stops working.",
  unclaimedTokenAutoReturnOff: "Off",
  autoReturnOption1h: "1 hour",
  autoReturnOption6h: "6 hours",
  autoReturnOption24h: "24 hours",
  autoReturnOption3d: "3 days",
  autoReturnOption7d: "7 days",
