...
export const en = {
  ...
  recurringPaymentEditTitle: "Edit recurring payment",
  ...
  recurringNoPayableContacts: "No contact with an npub or Lightning address.",
  recurringChangeRecipient: "Change recipient",
  recurringFrequencyLabel: "How often",
  recurringPresetDaily: "Daily",
  recurringPresetWeekly: "Weekly",
  recurringPresetMonthly: "Monthly",
  recurringFirstRunLabel: "First payment",
  recurringSummaryNext: "Next payment {date}",
  recurringSave: "Set up recurring payment",
  recurringSaveChanges: "Save changes",
  recurringFirstRunInPast: "The first payment cannot be in the past.",
  recurringInvalidForm:
    "Choose a recipient, an amount, and the first payment date.",
  recurringEveryHour: "hourly",
  recurringEveryDay: "daily",
  recurringEveryWeek: "weekly",
  recurringEveryMonth: "monthly",
  ...
  evoluShardOwner: "Shard owner",
  evoluShardRotate: "Rotate {scope} shard",
  evoluShardRotating: "Rotating {scope} shard…",
  evoluShardFixed: "Fixed shard",
  evoluSyncedOwners: "Synced owners",
