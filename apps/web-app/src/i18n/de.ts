...
export const de = {
  ...
  recurringPaymentNewTitle: "Neuer Dauerauftrag",
  recurringPaymentTitle: "Dauerauftrag",
  showRecurringPayments: "Daueraufträge",
  recurringEmpty: "Noch keine Daueraufträge.",
  recurringOnlyWhileOpen:
    "Zahlungen gehen nur, solange Linky auf dem zahlenden Gerät geöffnet ist.",
  ...
  recurringUnitDays: "Tag(e)",
  recurringUnitWeeks: "Woche(n)",
  recurringUnitMonths: "Monat(e)",
  recurringFirstRunLabel: "Erste Zahlung",
  recurringMaxRunsLabel: "Anzahl Zahlungen (optional)",
  recurringNoteLabel: "Notiz (optional)",
  recurringSave: "Dauerauftrag anlegen",
  recurringInvalidForm:
    "Bitte Bezeichnung, Empfänger, Betrag, Intervall und Datum der ersten Zahlung prüfen.",
  recurringEveryHour: "jede Stunde",
  recurringEveryDay: "jeden Tag",
  recurringEveryWeek: "jede Woche",
  recurringEveryMonth: "jeden Monat",
  recurringEveryNHours: "alle {count} Stunden",
  ...
  recurringStatusFinished: "beendet",
  recurringPause: "Pausieren",
  recurringResume: "Fortsetzen",
  recurringRunNow: "Jetzt zahlen",
  recurringDeviceLabel: "Gerät",
  recurringRunsOnThisDevice: "dieses Gerät zahlt",
  recurringRunsOnOtherDevice: "ein anderes Gerät zahlt",
