...
export const de = {
  ...
  cashuReturnUnclaimed: "Nicht abgeholte zurückholen",
  cashuReturningUnclaimed: "Wird zurückgeholt…",
  cashuReturnUnclaimedNothing: "Kein nicht abgeholter Token zum Zurückholen.",
  cashuReturnUnclaimedDone:
    "In die Wallet zurückgeholt: {count} Token ({amount}).",
  cashuReturnUnclaimedClaimed: "Bereits abgeholt: {count}.",
  cashuReturnUnclaimedFailed: "Nicht zurückholbar: {count}.",
  cashuTokenAutoReturnAt:
    "Dieser nicht abgeholte Token kehrt {when} von selbst in die Wallet zurück.",
  unclaimedTokenAutoReturn: "Nicht abgeholte Token zurückholen",
  unclaimedTokenAutoReturnHint:
    "Ein ausgegebener Token, den niemand innerhalb der gewählten Zeit abholt, kehrt von selbst in die Wallet zurück. Die Kopie beim Empfänger wird dann ungültig.",
  unclaimedTokenAutoReturnOff: "Aus",
  autoReturnOption1h: "1 Stunde",
  autoReturnOption6h: "6 Stunden",
  autoReturnOption24h: "24 Stunden",
  autoReturnOption3d: "3 Tage",
  autoReturnOption7d: "7 Tage",
