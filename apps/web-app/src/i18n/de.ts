...
export const de = {
  ...
  recurringPaymentEditTitle: "Wiederkehrende Zahlung bearbeiten",
  ...
  recurringRecipientUnavailable:
    "Die wiederkehrende Zahlung kann nicht gesendet werden: Der Kontakt hat weder npub noch Lightning-Adresse.",
  recurringWalletBusy:
  ...
  recurringSearchContacts: "Kontakt suchen",
  recurringNoPayableContacts: "Kein Kontakt mit npub oder Lightning-Adresse.",
  recurringChangeRecipient: "Empfänger ändern",
  recurringFrequencyLabel: "Wie oft",
  ...
  recurringSummaryNext: "Nächste Zahlung {date}",
  recurringSave: "Wiederkehrende Zahlung einrichten",
  recurringSaveChanges: "Änderungen speichern",
  recurringFirstRunInPast:
    "Die erste Zahlung kann nicht in der Vergangenheit liegen.",
  recurringInvalidForm:
    "Bitte Empfänger, Betrag und Datum der ersten Zahlung wählen.",
  recurringEveryHour: "stündlich",
  recurringEveryDay: "täglich",
  recurringEveryWeek: "wöchentlich",
  recurringEveryMonth: "monatlich",
  ...
  evoluShardOwner: "Shard-Eigentümer",
  evoluShardRotate: "Shard {scope} rotieren",
  evoluShardRotating: "Shard {scope} wird rotiert…",
  evoluShardFixed: "Fester Shard",
  evoluSyncedOwners: "Synchronisierte Eigentümer",
