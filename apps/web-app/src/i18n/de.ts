...
export const de = {
  ...
  bluetoothRoom: "Öffentlicher Bluetooth-Chat",
  bluetoothNearby: "In der Nähe",
  bluetoothNearbyUsers: "Linky-Nutzer in der Nähe",
  bluetoothNearbyCount: "Geräte in der Nähe: {count}",
  bluetoothDisclosure:
    "Teilt Ihren öffentlichen Namen und Schlüssel mit Personen in der Nähe. Der öffentliche Chat funktioniert mit BitChat. Linky muss geöffnet bleiben.",
  bluetoothUnsupported:
    "Bluetooth-Chat ist nur in einer unterstützten nativen App verfügbar.",
  bluetoothPermissionDenied:
    "Erlauben Sie Linky den Bluetooth-Zugriff in den Telefoneinstellungen.",
  bluetoothOff: "Bluetooth-Chat ist ausgeschaltet.",
  bluetoothRadioOff: "Schalten Sie Bluetooth am Telefon ein.",
  bluetoothPaused:
    "Bluetooth-Chat ist pausiert. Öffnen Sie Linky, um sich zu verbinden.",
  bluetoothActive: "Bluetooth-Chat ist aktiv.",
  bluetoothPublicNotice:
    "Ein öffentlicher Raum mit BitChat. Andere können diese Nachrichten lesen und über weitere Telefone weiterleiten. Private Chats bleiben über Nostr verschlüsselt.",
  bluetoothNoMessages:
    "Noch keine Nachrichten. Öffnen Sie BitChat oder Linky auf einem Telefon in der Nähe.",
  bluetoothMessageLimit:
    "Bis zu {count} Bytes pro Nachricht für BitChat-Kompatibilität.",
  bluetoothMessagePlaceholder: "Nachricht an den öffentlichen Raum",
  bluetoothSendFailed:
    "Senden fehlgeschlagen. Prüfen Sie Bluetooth und versuchen Sie es erneut.",
  ...
  showProfileQrOnTilt: "Profil durch Kippen anzeigen",
  ...
  cashuInventoryHint:
    "Die Spalte „Bei der Mint“ ist die aktuelle Antwort der Mint; die Wallet handelt nach dem gespeicherten Zustand.",
  cashuProofsTable: "Proofs",
  cashuOperationsTable: "Vorgänge",
  cashuProofStateAvailable: "Verfügbar",
  cashuProofStateHeld: "Gehalten",
  cashuProofStateHandedOut: "Ausgegeben",
  cashuProofStateExternalized: "Außerhalb der App übergeben",
  cashuMintStateUnspent: "nicht ausgegeben",
  cashuMintStatePending: "ausstehend",
  cashuMintStateSpent: "ausgegeben",
  cashuMintStateUnknown: "unbekannt",
  cashuProofsColumnAmount: "Betrag",
  ...
  cashuTransfersEmpty: "Keine offenen Übertragungen.",
  cashuTransferIssued: "Ausgestellt, wartet auf Einlösung.",
  cashuTransferReturned: "In die Wallet zurückgeholt.",
  cashuTransferClaimed: "Vom Empfänger eingelöst.",
  cashuTransferReceived: "In die Wallet aufgenommen.",
  cashuReceivePending: "Empfang wurde nicht abgeschlossen.",
  cashuReceiveFailed: "Empfang fehlgeschlagen.",
  cashuNoProofs: "Keine Proofs.",
  ...
  lnurlAuthTitleLink: "Konto bei {domain} verknüpfen?",
  lnurlAuthTitleAuth: "Gegenüber {domain} authentifizieren?",
  lnurlAuthBody:
    "Linky signiert mit einem Schlüssel, der nur für diese Domain abgeleitet wird — andere Seiten erkennen dich daran nicht. Es wird kein Geld gesendet.",
  lnurlAuthConfirm: "Bestätigen",
  lnurlAuthInProgress: "Anmeldung läuft…",
  lnurlAuthSucceeded: "{domain} hat die Anmeldung bestätigt.",
