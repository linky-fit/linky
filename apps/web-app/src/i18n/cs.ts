export const cs = {
  ...
  recurringPaymentsTitle: "Pravidelné platby",
  recurringPaymentTitle: "Pravidelná platba",
  recurringPaymentNewTitle: "Nová pravidelná platba",
  recurringPaymentEditTitle: "Upravit pravidelnou platbu",
  ...
  recurringRecipientUnavailable:
    "Pravidelnou platbu nelze odeslat: kontakt nemá npub ani Lightning adresu.",
  recurringWalletBusy:
  ...
  recurringNoPayableContacts: "Žádný kontakt s npub nebo Lightning adresou.",
  recurringChangeRecipient: "Změnit příjemce",
  recurringFrequencyLabel: "Jak často",
  recurringPresetDaily: "Denně",
  recurringPresetWeekly: "Týdně",
  recurringPresetMonthly: "Měsíčně",
  recurringFirstRunLabel: "První platba",
  recurringSummaryNext: "Další platba {date}",
  recurringSave: "Nastavit pravidelnou platbu",
  recurringSaveChanges: "Uložit změny",
  recurringFirstRunInPast: "První platba nemůže být v minulosti.",
  recurringInvalidForm: "Vyberte příjemce, částku a datum první platby.",
  recurringEveryHour: "každou hodinu",
  recurringEveryDay: "denně",
  recurringEveryWeek: "týdně",
  recurringEveryMonth: "měsíčně",
  ...
  evoluShardOwner: "Owner shardu",
  evoluShardRotate: "Otočit shard {scope}",
  evoluShardRotating: "Otáčím shard {scope}…",
  evoluShardFixed: "Pevný shard",
  evoluSyncedOwners: "Synchronizovaní owneři",
