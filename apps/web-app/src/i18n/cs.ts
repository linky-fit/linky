export const cs = {
  ...
  cashuReturnUnclaimed: "Vrátit nevyzvednuté",
  cashuReturningUnclaimed: "Vracím…",
  cashuReturnUnclaimedNothing: "Žádný nevyzvednutý token k vrácení.",
  cashuReturnUnclaimedDone: "Vráceno do peněženky: {count} tokenů ({amount}).",
  cashuReturnUnclaimedClaimed: "Už vyzvednuto: {count}.",
  cashuReturnUnclaimedFailed: "Nepodařilo se vrátit: {count}.",
  cashuTokenAutoReturnAt:
    "Nevyzvednutý token se sám vrátí do peněženky {when}.",
  unclaimedTokenAutoReturn: "Vracet nevyzvednuté tokeny",
  unclaimedTokenAutoReturnHint:
    "Vydaný token, který si nikdo nevyzvedne do zvolené doby, se sám vrátí do peněženky. Kopie, kterou má příjemce, pak přestane platit.",
  unclaimedTokenAutoReturnOff: "Vypnuto",
  autoReturnOption1h: "1 hodina",
  autoReturnOption6h: "6 hodin",
  autoReturnOption24h: "24 hodin",
  autoReturnOption3d: "3 dny",
  autoReturnOption7d: "7 dní",
