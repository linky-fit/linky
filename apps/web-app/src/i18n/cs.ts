export const cs = {
  ...
  recurringPaymentNewTitle: "Nový trvalý příkaz",
  recurringPaymentTitle: "Trvalý příkaz",
  showRecurringPayments: "Trvalé příkazy",
  recurringEmpty: "Zatím žádné trvalé příkazy.",
  recurringOnlyWhileOpen:
    "Platby odchází jen když je Linky otevřená na zařízení, které příkaz platí.",
  ...
  recurringUnitDays: "dní",
  recurringUnitWeeks: "týdnů",
  recurringUnitMonths: "měsíců",
  recurringFirstRunLabel: "První platba",
  recurringMaxRunsLabel: "Počet plateb (volitelné)",
  recurringNoteLabel: "Poznámka (volitelné)",
  recurringSave: "Vytvořit trvalý příkaz",
  recurringInvalidForm:
    "Zkontrolujte název, příjemce, částku, interval a datum první platby.",
  recurringEveryHour: "každou hodinu",
  recurringEveryDay: "každý den",
  recurringEveryWeek: "každý týden",
  recurringEveryMonth: "každý měsíc",
  recurringEveryNHours: "každých {count} hodin",
  ...
  recurringStatusFinished: "ukončeno",
  recurringPause: "Pozastavit",
  recurringResume: "Obnovit",
  recurringRunNow: "Zaplatit teď",
  recurringDeviceLabel: "Zařízení",
  recurringRunsOnThisDevice: "platí toto zařízení",
  recurringRunsOnOtherDevice: "platí jiné zařízení",
  ...
  cashuMissingRestoreHint:
    "Vyhledá neznámé proofs a nalezené vymění za nové. Mint může účtovat poplatek.",
  cashuMissingRestoreDone: "Obnoveno {amount} sat do nových proofs.",
  cashuMissingRestoreIncomplete:
    "Vyměněno {amount} sat. Některé minty se nepodařilo prohledat nebo některé nalezené proofs vyměnit. Nevyměněné proofs zůstávají v peněžence; obnovu najdete v Prozkoumat proofs.",
  cashuJustCreated: "Právě vytvořeno",
  cashuPendingMinutes: "Čeká {minutes} min",
  cashuPendingHours: "Čeká {hours} h",
  cashuTotalBalance: "Celkem",
  cashuPendingBalance: "V čekajících tokenech",
  cashuInspectProofs: "Prozkoumat proofs",
  cashuPendingTransfers: "Čekající převody",
  cashuAwaitingDelivery: "Čeká na doručení",
  cashuAwaitingClaim: "Čeká na vyzvednutí",
  cashuPartiallyClaimed: "Částečně vyzvednuto",
  cashuHandoffIssued: "Vydaný token",
  cashuHandoffNfc: "Zapsáno na NFC",
  cashuHandoffReceived: "Přijatý token",
  cashuHandoffReclaimed: "Token získán zpět",
  cashuHandoffUnknown: "Způsob předání neznámý",
  cashuSentInChat: "Odesláno v chatu",
  cashuQueuedInChat: "Čeká na odeslání v chatu",
  cashuReceivedInChat: "Přijato v chatu",
  cashuChatContact: "Otevřít chat",
  cashuCreated: "Vytvořeno",
  cashuPendingOneDay: "Čeká 1 den",
  cashuPendingDays: "Čeká {days} dní",
  tokens: "Tokeny",
  ...
  cashuReclaimHint:
    "Vrátí neutracené tokeny sdílené nebo zapsané na NFC. Jejich původní kopie přestanou fungovat. Mint může účtovat poplatky.",
  cashuRestoreAndReclaimHint:
    "Vyhledá chybějící tokeny a vrátí všechny dostupné i předané tokeny včetně NFC. Původní kopie přestanou fungovat. Mint může účtovat poplatky.",
  ...
  cashuShowTokenQr: "Zobrazit QR kód tokenu",
  ...
  showProfileQrOnTilt: "Naklopením zobrazit profil",
  ...
  cashuReturnToWallet: "Získat token zpět a vrátit do peněženky",
  ...
  cashuMintStateUnknown: "neznámý",
  cashuProofsColumnAmount: "Částka",
  ...
  cashuTransferIssued: "Emitováno, čeká na vyzvednutí.",
  cashuTransferReturned: "Vráceno do peněženky.",
  cashuTransferClaimed: "Vyzvednuto příjemcem.",
  cashuTransferReceived: "Přijato do peněženky.",
  ...
  lnurlAuthTitleLink: "Propojit účet na {domain}?",
  lnurlAuthTitleAuth: "Ověřit se vůči {domain}?",
  lnurlAuthBody:
    "Linky se podepíše klíčem odvozeným jen pro tuhle doménu — jiné weby tě podle něj nepoznají. Neposílají se žádné peníze.",
  lnurlAuthConfirm: "Potvrdit",
  lnurlAuthInProgress: "Přihlašuji…",
  lnurlAuthSucceeded: "Doména {domain} přihlášení potvrdila.",
