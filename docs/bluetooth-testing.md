...
1. Use different Linky accounts and enable Bluetooth chat on both.
2. Open Add contact. The other account appears in **Nearby Linky users**. Your own account and already saved contacts do not appear.
